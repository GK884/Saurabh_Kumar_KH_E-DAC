...
(1,'MAYUR','JAISWAL',25000,'ANALYST'),
(2,'PRAVIN','PATIL',350000,'ANALYST'),
(3,'DEVENDRA','BAVISKAR',500000,'DEVELOPER'),
(4,'HITESH','PATIL',85000,'TESTER');

INSERT INTO EMPLOYEE VALUES 
(5,'MANISHA','PATIL',28000,'DEV'),
(6,'SHIVAJI','MARATHA',390000,'ANALYST');

INSERT INTO EMPLOYEE VALUES 
(7,'PANKAJ','CHAVAN',1000,'DEV'),
(8,'VIRAT','KOHLI',500,'PROGRAMMER');
